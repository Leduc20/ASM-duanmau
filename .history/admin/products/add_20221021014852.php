                ...
                <form onsubmit="return checkSelect()" action="index.php?act=addhh" method="post" id="checkproduct" enctype="multipart/form-data">
                    <div class="grid grid-cols-3 gap-8">
                        ...
                        <div>
                            ...
                            <input class="border w-full p-2 rounded-[4px]" type="text" name="sale" id="sale" value="<?= isset($sale) ? $sale : '' ?>">
                            <?php
                            if (isset($salesale)) : ?> <br>
                                <p class="flex justify-end text-red-500"><?= $salesale?></p>
                            <?php endif ?>
                        </div>
                        <div>
