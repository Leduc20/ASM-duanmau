...
<body>
    <section class="mt-[-366px] ml-[99px]">
        <div class="max-w-[1200px] mx-auto">
            ...
            <div>
                <form action="index.php?act=addhh" method="post" id="checkproduct" enctype="multipart/form-data">
                    <div class="grid grid-cols-3 gap-8">
                        ...
                        <div>
                            ...
                            <textarea class="border" name="detail" id="detail" cols="49" rows="10"></textarea>
                        </div>
                        <div>
                    ...
                    <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded" href="index.php?act=dshh">Danh sách</a>
                </form>
            </div>
        </div>
    </section>
