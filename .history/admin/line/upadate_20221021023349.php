...
<head>
    ...
    <title>Update Loại Han</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css">
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/js/bootstrap.bundle.min.js"></script>
    <script>
        $().ready(function() {
            $("#check_up_line").validate({
                onfocusout: false,
                onkeyup: false,
                onclick: false,
                rules: {
...
<body>
    <section class="mt-[-336px] ml-[99px]">
        <div class="max-w-[1200px] m-auto">
            ...
            <div>
                <form action="index.php?act=update" method="post" enctype="multipart/form-data" id="check_up_line">
                    ...
                    <input class="border w-full p-2 rounded-[4px]" type="text" name="tenloai" id="name" value="<?php if (isset($name) && ($name != "")) echo $name; ?>">
