        ...
        <div class="max-w-[1200px] m-auto">
            ...
            <div>
                <form action="index.php?act=addlh" method="post" id="check-line" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" name="themmoi">Thêm mới</button>
                    <button type="reset" class="p-2 rounded border mt-3">Nhập lại</button>
                    <a class="border border-black" href="index.php?act=dslh">Danh sách</a>
                </form>
            </div>
