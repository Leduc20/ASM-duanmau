        ...
        <div class="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
            ...
            <div class="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
                ...
                <div>
                    ...
                    <ul class="text-[20px]">
                        <li><a class="p" href="index.php?act=edit_taikhoan">Cập nhật thông tin tài khoản</a></li>
                        <li><a class="p" href="../admin/index.php">Đăng nhập admin</a></li>
                        <li><a class="p" href="index.php?act=thoat">Đăng xuất</a></li>
                    </ul>
                </div>
