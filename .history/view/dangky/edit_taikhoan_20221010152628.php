...
<body>
    <section class="max-w">
        <div class="max-w-[800px] m-auto mt-5">
            ...
            <?php 
            if(isset($_SESSION['user']) && isa($_SESSION['user'])){
            ...
            <form action="index.php?act=edit_taikhoan" method="post">
                ...
                <input class="border w-full p-2 rounded-[4px]" type="email" name="email" id="">
                <p class="font-bold mt-3 mb-2">Tên đăng nhập</p>
                <input class="border w-full p-2 rounded-[4px]" type="text" name="user" id="">
                <p class="font-bold mt-3 mb-2">Mật khẩu</p>
                <input class="border w-full p-2 rounded-[4px]" type="password" name="pass" id="">
                <p class="font-bold mt-3 mb-2">Địa chỉ</p>
                <input class="border w-full p-2 rounded-[4px]" type="text" name="addres" id="">
                <p class="font-bold mt-3 mb-2">Số điện thoại</p>
                <input class="border w-full p-2 rounded-[4px]" type="text" name="phone" id="">
