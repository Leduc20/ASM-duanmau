    ...
    <section class="max-w">
        ...
        <div class="md:flex justify-between mx-auto max-w-[1200px] mt-5 items-center">
            ...
            <div class="hidden md:block">
                <div class="flex">
                    <div class="dropdown">
                        <a name="dangnhap" href="index.php?act=" class="btn btn-primary dropdown-toggle bg-sky-500" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
