...
<body onload="loadAnh()" class="px-2">
    <section class="max-w">
        ...
        <div class="md:flex justify-between mx-auto max-w-[1200px] mt-5 items-center">
            ...
            <div class="index.php?act=sanpham" method="post">
                <form action="">
                    ...
                    <button class="border-[1px] w-[45px] bg-orange-300" name="seach" type="submit"><i class="fa-solid fa-magnifying-glass"></i></button>
                </form>
            </div>
            <!-- Login/Cart -->
