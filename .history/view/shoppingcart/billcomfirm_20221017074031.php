<section class="max-w ">
    ...
    <div class="grid grid-cols-1 max-w-[800px] m-auto mt-5 mb-5 border rounded p-6 bg-white">
        ...
        <div class="flex items-center rounded border border-gray-200 dark:border-gray-700 text-center">
            ...
            <p class="py-4 w-full text-[19px] font-bold text-gray-900 dark:text-gray-300">Tổng đơn: <?=$bill['sum']?></p>
    ...
    <div class="grid grid-cols-1 max-w-[800px] m-auto mt-5 mb-5 border rounded p-6 bg-white">
        ...
        <div class="flex items-center rounded border border-gray-200 dark:border-gray-700 text-center">
            <p class="py-4 w-full text-[19px] font-bold text-gray-900 dark:text-gray-300"><?=$bill['bill_ptt']?></p>
        </div>
    </div>
