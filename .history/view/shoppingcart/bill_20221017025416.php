<section class="max-w">
        <div class="max-w-[800px] m-auto mt-5">
            ...
            <form action="" method="post">
                ...
                <input class="border w-full p-2 rounded-[4px]" type="email" name="name" id="" value="<?=$email?>">
                <p class="font-bold mt-3 mb-2">Địa chỉ</p>
                <input class="border w-full p-2 rounded-[4px]" type="text" name="addres" id=""  value="<?=$name?>">
                <p class="font-bold mt-3 mb-2">Email</p>
                <input class="border w-full p-2 rounded-[4px]" type="password" name="email" id="" value="<?=$password?>">
