<section class="max-w ">
    ...
    <div class="grid grid-cols-3 gap-6 max-w-[800px] m-auto mt-5 mb-5 border rounded p-6 bg-white">
        <div class="flex items-center pl-4 rounded border border-gray-200 dark:border-gray-700 text-center">
            <label class="py-4 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">Trả tiền khi nhận hàng</label>
        </div>
        </div>
