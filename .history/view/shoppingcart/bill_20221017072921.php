    ...
    <section class="max-w ">
        ...
        <div class="grid grid-cols-3 gap-6 max-w-[1200px] m-auto mt-5 mb-5 border rounded p-6 bg-white">
            ...
            <div class="flex items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
                <input id="bordered-radio-1" type="radio" value="" name="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
