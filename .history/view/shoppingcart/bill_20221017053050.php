                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="index.php?act=billcomfirm" type="button" name="dongy" class="btn bg-sky-300 hover:bg-emerald-800 hover:text-white" value="">Đồng ý đặt hàng</a>
                        </td>
                        <!-- <td>
                            <a href="index.php?act=bill">
