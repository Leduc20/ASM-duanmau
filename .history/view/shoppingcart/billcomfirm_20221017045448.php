<section class="max-w ">
    ...
    <div class="grid grid-cols-1 max-w-[800px] m-auto mt-5 mb-5 border rounded p-6 bg-white">
        ...
        <div class="flex items-center rounded border border-gray-200 dark:border-gray-700 text-center">
            <p class="py-4 w-full text-[19px] font-bold text-gray-900 dark:text-gray-300">DD<?=$bill['id']?>/p>
        </div>
    </div>
    ...
    <div class="max-w-[800px] m-auto border rounded bg-white p-6">
        ...
        <form action="" method="post">
            ...
            <input class="border w-full p-2 rounded-[4px]" type="text" name="addres" id="" value="<?=$bill['bill_name']?>">
            <p class="font-bold mt-3 mb-2">Email</p>
            <input class="border w-full p-2 rounded-[4px]" type="email" name="email" id="" value="<?=$bill['bill_name']?>">
            <p class="font-bold mt-3 mb-2">Số điện thoại</p>
            <input class="border w-full p-2 rounded-[4px]" type="text" name="phone" id="" value="<?=$bill['bill_name']?>">
     </form>
    </div>
