                ...
                <tbody>
                    <?php
                      foreach ($_SESSION['mycart'] as $show) {
                        ...
                        <input type="email" class="form-control" id="exampleInputEmail1" value="'.$su.'">
                        </td>
                        <td class="col-sm-1 col-md-1 text-center w-[60px]"><strong>'.$show[3].' VNĐ</strong></td>
                        <td class="col-sm-1 col-md-1 text-center w-[60px]"><strong>'.$show[5].' VNĐ</strong></td>
                        <td class="col-sm-1 col-md-1">
                        <button type="button" name="delete" class="btn btn-danger text-black">
