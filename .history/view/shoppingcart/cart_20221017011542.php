                ...
                <tbody>
                    <?php
                      foreach ($_SESSION['mycart'] as $show) {
                        ...
                        $sum=$show[3]*$show[4];
                        $sumall+=$sum;
                        $delete_sp='<a href="index.php?act=del_cart&idcart="'.$show.'><input type="button" name="" id="" value="Xóa"></a>';
                        echo '
                        <tr>
                        ...
                        <a href="'.$delete_sp.'" type="button" name="delete" class="btn btn-danger text-black">
