            ...
            <div class="flex justify-between grid grid-cols-1 gap-4 md:grid-cols-3 gap-6 mt-6">
                <?php foreach ($showProducts as $show) {
                    ...
                    <div class="px-5 pb-5">
                        ...
                        <div class="flex justify-between items-center">
                            <div class="grid">
                                ...
                                <a href="index.php?act=addcart" name="addcart" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
                            </div>
                        </div>
                    <form action="index.php?act=addcart" method="post">
                        ...
                        <input type="submit" name="addcart" id="" value="Add to cart">
                      </form>
                    </div>
                </div>
            ';
