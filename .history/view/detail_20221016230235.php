...
<body>
  ...
  if (is_array($sp)) {
    ...
    $img = $img_path . $image;
    echo '
    <h2 class="text-[30px] font-normal mt-0 mb-2 w-[1200px] mx-auto font-bold">
    Chi tiết sản phẩm <span>' . $name_pro . '</span>
  </h2>
      ...
      <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div class="flex">
              <span class="title-font font-medium text-2xl text-gray-900">' . $price . ' VNĐ</span>
  ...
  ?>
  <div>
    <img src="../view/comment/commentform.php" alt="">
    <script>
    ...
    <div>
      <div class="slider">
        <ul id="autoWidth" class="Sc-hidden">
          <!--1------------------------------------>
          <?php
