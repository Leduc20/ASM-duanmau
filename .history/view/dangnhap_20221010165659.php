        ...
        <div class="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
            ...
            <div class="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
                ...
                <div>
                    ...
                    <ul class="text-[20px]">
                        <li class="py-4 bg-sky-400 mb-2 mt-2 border rounded"><a class="px-4" href="index.php?act=edit_taikhoan">Cập nhật thông tin tài khoản</a></li>
                        <li class="py-4 bg-sky-400 mb-2 mt-2 border rounded"><a class="px-4" href="../admin/index.php">Đăng nhập admin</a></li>
                        <li class="py-4 bg-sky-400 mb-2 mt-2 border rounded"><a class="px-4" href="index.php?act=thoat">Đăng xuất</a></li>
                    </ul>
                </div>
