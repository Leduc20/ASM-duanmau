        ...
        <div class="md:flex justify-between mx-auto max-w-[1200px] mt-5 items-center">
            ...
            <div class="">
                <form action="">
                    ...
                    <input class="border-[1px] w-[295px]" type="text" name="keyw" id="">
                    <button class="border-[1px] w-[45px] bg-orange-300" name="timkiem" type="submit"><i class="fa-solid fa-magnifying-glass"></i></button>
                </form>
            </div>
            <!-- Login/Cart -->
