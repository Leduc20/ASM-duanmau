    ...
    <div class="flex mx-auto items-center justify-center shadow-lg mt-56 mx-8 mb-4 max-w-[1200px]">
        ...
        <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post" id="comment">
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-full px-3 mb-2 mt-2">
                    <textarea name="content"" class="bg-gray-100 rounded border border-gray-400 leading-normal resize-none w-full h-20 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white" name="body" placeholder="Bình luận...."></textarea>
                </div>
                <div class="w-full md:w-full flex items-start md:w-full px-3">
                    <div class="flex items-start w-1/2 text-gray-700 px-2 mr-auto">
