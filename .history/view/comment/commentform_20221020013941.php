            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-full flex items-start md:w-full px-3">
                    ...
                    <div class="-mr-1">
                        ...
                        <input type="submit" name="send" class="bg-white text-gray-700 font-medium py-1 px-4 border border-gray-400 rounded-lg hover:bg-gray-100 tracking-wide mr-1 " value="Bình luận">
                        <input type="submit" name="send" id="" value="Add to cart" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    </div>
                </div>
        </form>
        <?php
