        ...
        <div class="md:flex justify-between mx-auto max-w-[1200px] mt-5 items-center">
            ...
            <div class="hidden md:block">
                <div class="flex">
                    ...
                    <div class="ml-4">
                        <button class="bg-sky-500 btn btn-primary" type="submit"><i class="mr-[5px] fa-sharp fa-solid fa-cart-arrow-down"></i>Giỏ hàng</button>
                    </div>
...
<!-- Dropdown menu -->
<div id="dropdownDivider" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 210px);">
