...
function insert_bill($name,$email,$address,$phone,$pttt,$date_buy,$tongdonhang){
    $sql="inser into bill(bill_name,bill_email,bill_address,bill_phone,bil_pttt,date_buy,total) value('$name','$email','$address','$phone','$pttt','$date_buy','$tongdonhang')";
    pdo_execute($sql);
    return pdo_execute_lastInsertId($sql);
}
function insert_cart($id_user,$id_hh,$price,$soluong,$thanhtien,$id_bill,$tongdonhang){
    $sql="inser into `cart`(`id_user`, `id_hh`, `price`, `soluong`, `thanhtien`, `id_bill`) value('$id_user','$id_hh','$price','$soluong','$thanhtien','$date_buy','$tongdonhang')";
    pdo_execute($sql);
}
function view_infor()
{
