...
function insert_bill($name,$email,$addres,$phone,$pttt,$date_buy,$tongdonhang){
    $sql="inser into bill(bill_name,bill_email,bill_address,bill_phone,bil_pttt,date_buy,total) value('$name','$email','$addres','$phone','$pttt','$date_buy','$tongdonhang')";
    pdo_execute();
}
function view_infor()
{
