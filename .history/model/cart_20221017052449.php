...
function insert_bill($name,$email,$address,$phone,$pttt,$date_buy,$tongdonhang){
    $sql="insert into `bill`(`bill_name`, `bill_address`, `bill_phone`, `bill_email`, `bill_pttt`, `date_buy`, `sum`, `bill_status`, `receive_name`, `receive_address`, `receive_phone`) value('$name','$address','$phone','$email','$pttt','$date_buy','$tongdonhang')";
    pdo_execute($sql);
