...
function view_infor()
{
    ...
    <form action="" method="post">
            ...
            <p class="border w-full p-2 rounded-[4px]" type="text" name="name" id="" value="'.$name.'"></p>
            <p class="font-bold mt-3 mb-2">Địa chỉ</p>
            <p class="border w-full p-2 rounded-[4px]" type="text" name="addres" id="" value="'.$addres.'">
            <p class="font-bold mt-3 mb-2">Email</p>
            <p class="border w-full p-2 rounded-[4px]" type="email" name="email" id="" value="'.$email.'">
            <p class="font-bold mt-3 mb-2">Số điện thoại</p>
            <p class="border w-full p-2 rounded-[4px]" type="text" name="phone" id="" value="'.$phone.'">
     </form>
    ';
}
